            ...
            if (operacion.equals(conversionDeMoneda)) {
                ...
                String operacaoMoedas = JOptionPane.showInputDialog(null, "Elige una moneda",
                        "Monedas", JOptionPane.QUESTION_MESSAGE, null, new String[] {
                                TipoConversion.COP_PARA_DOLAR.getDescripcion(),
                                TipoConversion.COP_PARA_EURO.getDescripcion(),
                                TipoConversion.COP_PARA_LIBRA_ESTERLINA.getDescripcion(),
                                TipoConversion.COP_PARA_PESO_ARGENTINO.getDescripcion(),
                                TipoConversion.COP_PARA_PESO_CHILENO.getDescripcion(),
                                TipoConversion.DOLAR_PARA_COP.getDescripcion(),
                                TipoConversion.EURO_PARA_COP.getDescripcion(),
                                TipoConversion.LIBRA_ESTERLINA_PARA_COP.getDescripcion(),
                                TipoConversion.PESO_ARGENTINO_PARA_COP.getDescripcion(),
                                TipoConversion.PESO_CHILENO_PARA_COP.getDescripcion()},
                        "Escolha").toString();
